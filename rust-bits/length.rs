...
#[no_mangle]
extern "C" fn length_fill() -> *mut Length {
    Box::into_raw(Box::new(Length::Fill))
}

#[no_mangle]
extern "C" fn length_fill_portion(portion: c_ushort) -> *mut Length {
    Box::into_raw(Box::new(Length::FillPortion(portion)))
}

#[no_mangle]
extern "C" fn length_shrink() -> *mut Length {
    Box::into_raw(Box::new(Length::Shrink))
}

#[no_mangle]
extern "C" fn length_fixed(value: c_float) -> *mut Length {
