...
#[no_mangle]
pub extern "C" fn canvas_style_solid(r: c_float, g: c_float, b: c_float, a: c_float) -> *mut Style {
    let color = Color::new(r, g, b, a);
    Box::into_raw(Box::new(Style::Solid(color)))
}

#[no_mangle]
pub extern "C" fn canvas_style_gradient(gradient_ptr: *mut Gradient) -> *mut Style {
