...
-- builder x y radius
foreign import ccall "path_builder_circle"
...
-- builder x y
foreign import ccall "path_builder_line_to"
...
-- builder x y
foreign import ccall "path_builder_move_to"
...
foreign import ccall "path_builder_rectangle"
